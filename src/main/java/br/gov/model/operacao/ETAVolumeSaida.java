...
public class ETAVolumeSaida implements Serializable{
	private static final long serialVersionUID = -258338383301045857L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="sequence_eta_volume_saida")
	@SequenceGenerator(name="sequence_eta_volume_saida", sequenceName="sequence_eta_volume_saida", schema="operacao", allocationSize=1)
	@Column(name="etas_id")
