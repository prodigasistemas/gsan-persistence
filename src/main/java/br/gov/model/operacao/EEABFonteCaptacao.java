...
public class EEABFonteCaptacao implements BaseEntidade, Serializable{
	private static final long serialVersionUID = 8907687091063573313L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="sequence_eeab_fontecaptacao")
	@SequenceGenerator(name="sequence_eeab_fontecaptacao", sequenceName="sequence_eeab_fontecaptacao", schema="operacao", allocationSize=1)
    @Column(name="eebf_id")
