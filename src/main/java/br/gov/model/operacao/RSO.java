...
public class RSO implements BaseEntidade, Serializable{
	private static final long serialVersionUID = -941727346088100517L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="sequence_RSO")
	@SequenceGenerator(name="sequence_RSO", sequenceName="sequence_RSO", schema="operacao", allocationSize=1)
    @Column(name="rso_id")
    ...
    @Column(name="rso_tmultimaalteracao", nullable=false, insertable=false)
