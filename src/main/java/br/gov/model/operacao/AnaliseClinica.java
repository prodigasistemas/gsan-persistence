...
public class AnaliseClinica implements Serializable{
	...
	@SequenceGenerator(name="sequence_analise_clinica", sequenceName="sequence_analise_clinica", schema="operacao", allocationSize=1)
	@Column(name="anac_id")
    ...
    @Column(name="anac_tmultimaalteracao", nullable=false, insertable=false)
