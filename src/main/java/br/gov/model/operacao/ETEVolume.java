...
public class ETEVolume implements Serializable{
	private static final long serialVersionUID = -1049271262780180005L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="sequence_ete_volume")
	@SequenceGenerator(name="sequence_ete_volume", sequenceName="sequence_ete_volume", schema="operacao", allocationSize=1)
	@Column(name="etev_id")
    ...
    @Column(name="etev_tmultimaalteracao", nullable=false, insertable=false)
