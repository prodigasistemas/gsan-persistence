...
public class ETAVolumeEntrada implements Serializable{
	private static final long serialVersionUID = -5079516452179128963L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="sequence_eta_volume_entrada")
	@SequenceGenerator(name="sequence_eta_volume_entrada", sequenceName="sequence_eta_volume_entrada", schema="operacao", allocationSize=1)
	@Column(name="etae_id")
