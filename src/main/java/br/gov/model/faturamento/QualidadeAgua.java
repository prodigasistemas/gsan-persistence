...
public class QualidadeAgua implements Serializable{
	...
	@Column(name="qlag_amreferenciaqlag_amreferencia")
	...
	@Column(name="qlag_qtcoliftermosconforme")
	...
	public void setQuantidadeCorAnalisadas(Integer quantidadeCorAlisadas) {
		this.quantidadeCorAnalisadas = quantidadeCorAlisadas;
	}
	...
	public void setQuantidadeAlcalinidadeAnalisadass(
			Integer quantidadeAlcalinidadeAnalisadass) {
