...
@Embeddable
public class FaturamentoAtivCronRotaPK implements Serializable{
	private static final long serialVersionUID = -2215082917140495961L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FaturamentoAtivCronRotaPK other = (FaturamentoAtivCronRotaPK) obj;
