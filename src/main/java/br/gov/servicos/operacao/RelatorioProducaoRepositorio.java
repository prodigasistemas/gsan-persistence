...
public class RelatorioProducaoRepositorio {

	@EJB
	ProxyOperacionalRepositorio fachadaProxy;

	public List<List> getProducaoDistribuicaoMensal(Integer codigoRegional, Integer codigoUnidadeNegocio, Integer tipoUnidadeOperacional,
		...
		builder.append("SELECT * FROM (")
				...
				.append("	  LEFT JOIN cadastro.gerencia_regional J ON A.greg_id = J.greg_id) A").append("	 WHERE referencia = '" + dataRef + "'");
