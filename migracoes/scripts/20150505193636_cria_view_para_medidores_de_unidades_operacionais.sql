...
select eab.mmed_idsaida as id, 1 as tipo, eeab_id as id_unidade_operacional, 
...
union 
select eat.mmed_idsaida as id, 3 as tipo, eeat_id as id_unidade_operacional, 
medidor.mmed_tipomedicao as tipo_medicao, medidor.mmed_idleitura as identificador_leitura
...
union 
select eta.mmed_idsaida as id, 2 as tipo, eta_id as id_unidade_operacional, 
medidor.mmed_tipomedicao as tipo_medicao, medidor.mmed_idleitura as identificador_leitura
